...
const Navbar = () => {
  ...
  const navLinks = [
    ...
    { name: 'Documentation', href: '#faq' }, // Updated to point to FAQ
    { name: 'Enterprise', href: '#security' }, // Updated to point to security
    { name: 'Contact', href: '#cta' } // Updated to point to CTA section
  ];
