...
const SuperAdminRevenue = () => {
  const revenueData = [
    ...
    { name: 'Apr', revenue: 61000, volume: 1800000 },
    { name: 'May', revenue: 59000, volume: 1700000 },
    { name: 'Jun', revenue: 75000, volume: 2200000 },
    { name: 'Jul', revenue: 85000, volume: 2500000 },
  ];
  ...
  return (
    <div className="space-y-6 animate-in fade-in zoom-in-95 duration-500">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        {[
          { title: "Total Processing Volume", amount: "$14.2M", change: "+24%", trend: "up" },
          { title: "Gateway Fee Revenue", amount: "$845K", change: "+12%", trend: "up" },
          { title: "Subscription Revenue", amount: "$124K", change: "+5%", trend: "up" },
          { title: "Pending Settlements", amount: "$2.1M", change: "-2%", trend: "down" }
        ].map((stat, i) => (
