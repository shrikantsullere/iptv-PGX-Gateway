  ...
  return (
    <div className="space-y-6 animate-in fade-in zoom-in-95 duration-500">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-black text-white flex items-center gap-3">
            <ShieldCheck className="w-8 h-8 text-[#7C3AED]" /> Merchant Rules
          </h1>
          <p className="text-gray-400 mt-1">Merchant-specific processing overrides and force-routing.</p>
        </div>
      </div>
      ...
      <div className="bg-[#13131A] border border-white/5 rounded-2xl shadow-xl overflow-hidden p-8 flex flex-col items-center justify-center text-center">
        ...
        <h2 className="text-2xl font-bold text-white mb-2">Module Active: Merchant Rules</h2>
